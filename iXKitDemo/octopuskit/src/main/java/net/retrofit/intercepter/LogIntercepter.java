package net.retrofit.intercepter;
...
public class LogIntercepter implements Interceptor {
    ...
    public Response intercept(Interceptor.Chain chain) throws IOException {
        ...
        try {
            ...
            Logger.e(e,"Failed chain.proceed! ");

            //@@ return null;
            String bodyString = "{ \"error\" : \"" +  e.getLocalizedMessage() + "\"}";

            ResponseBody body = ResponseBody.create(MediaType.parse("application/json"), bodyString);
            Response.Builder builder =  new Response.Builder().request(request).protocol(Protocol.HTTP_1_1).code(404).message(bodyString);
